...
function viewLink(outerData, parentNode, prevNode, nextNode, html, refresh, context, validateOnly) {
	...
	// template rendering will be converted either to script marker nodes or, for element-only content SectionTemplates, to data-jsv element annotations.
...
$viewsSettings.advanced({
	...
	_wm: {
		...
		// unless wrapped in a div with non-breaking characters in reception of it.
